...
outside Canberra who are selected for the course.  Tuition is free for
all selected honours students.
...
To apply, existing honours students and those planning to take honours next
year should write a discussion of up to one page on
their interests in economics and computational methods, their future plans,
and why they believe they would benefit from a course on computational
techniques.  Students should also attach an academic transcript to their
application email.  Applications should be sent to both
\href{mailto:john.stachurski@anu.edu.au}{john.stachurski@anu.edu.au} and
